...
{
Memoria::Memoria(): ram({ 0 }), ppu(nullptr), controle_1(nullptr), controle_2(nullptr), cartucho(nullptr), interrupcoes(nullptr) {
...
tipos::byte Memoria::ler(tipos::uint16 endereco) {
...
tipos::uint16 Memoria::ler_16_bits(tipos::uint16 endereco) {
...
tipos::uint16 Memoria::ler_16_bits_bug(tipos::uint16 endereco) {
...
void Memoria::escrever(tipos::uint16 endereco, tipos::byte valor) {
