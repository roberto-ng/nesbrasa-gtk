...
export namespace nesbrasa::nucleo
{
    ...
    public:
        ...
        tipos::byte ler(Nes*, tipos::uint16); void escrever(Nes*, tipos::uint16, tipos::byte);
        tipos::byte registrador_ler(tipos::uint16); void registrador_escrever(Nes*, tipos::uint16, tipos::byte);
