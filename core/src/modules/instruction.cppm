...
export namespace nesbrasa::nucleo
{
    ...
    using InstrucaoImplementacao = std::function<void(CpuInterface*, InstrucaoModo, std::optional<tipos::uint16>)>;
...
namespace nesbrasa::nucleo
{
    ...
    A + M + C -> A, C
    */
    static void instrucao_adc(CpuInterface* cpu, InstrucaoModo modo, optional<uint16> endereco)
    {
    ...
    A AND M -> A
    */
    static void instrucao_and(CpuInterface* cpu, InstrucaoModo modo, optional<uint16> endereco)
    {
        byte valor = cpu->memoria->ler(endereco.value());
    ...
    */
    static void instrucao_asl(CpuInterface* cpu, InstrucaoModo modo, optional<uint16> endereco)
    {
    ...
    static void instrucao_bcc(CpuInterface* cpu, InstrucaoModo modo, optional<uint16> endereco)
    {
        if (cpu->c == false)
        {
    ...
    static void instrucao_bcs(CpuInterface* cpu, InstrucaoModo modo, optional<uint16> endereco)
    {
        if (cpu->c == true)
        {
            cpu->branch_somar_ciclos(endereco.value());
    ...
    static void instrucao_beq(CpuInterface* cpu, InstrucaoModo modo, optional<uint16> endereco)
    {
        if (cpu->z == true)
        {
            cpu->branch_somar_ciclos(endereco.value());
    ...
    */
    static void instrucao_bit(CpuInterface* cpu, InstrucaoModo modo, optional<uint16> endereco)
    {
        byte valor = cpu->memoria->ler(endereco.value());
    ...
    static void instrucao_bmi(CpuInterface* cpu, InstrucaoModo modo, optional<uint16> endereco)
    {
        if (cpu->n == true)
        {
            cpu->branch_somar_ciclos(endereco.value());
    ...
    static void instrucao_bne(CpuInterface* cpu, InstrucaoModo modo, optional<uint16> endereco)
    {
        if (cpu->z == false)
        {
            cpu->branch_somar_ciclos(endereco.value());
    ...
    static void instrucao_bpl(CpuInterface* cpu, InstrucaoModo modo, optional<uint16> endereco)
    {
        if (cpu->n == false)
        {
            cpu->branch_somar_ciclos(endereco.value());
    ...
    //! Instrução BRK
    static void instrucao_brk(CpuInterface* cpu, InstrucaoModo modo, optional<uint16> endereco)
    {
    ...
    static void instrucao_bvc(CpuInterface* cpu, InstrucaoModo modo, optional<uint16> endereco)
    {
        if (cpu->v == false)
        {
            cpu->branch_somar_ciclos(endereco.value());
    ...
    static void instrucao_bvs(CpuInterface* cpu, InstrucaoModo modo, optional<uint16> endereco)
    {
        if (cpu->v == true)
        {
            cpu->branch_somar_ciclos(endereco.value());
    ...
    //! Limpa a flag 'c'
    static void instrucao_clc(CpuInterface* cpu, InstrucaoModo modo, optional<uint16> endereco)
    {
        cpu->c = false;
    }

    //! Limpa a flag 'd'
    static void instrucao_cld(CpuInterface* cpu, InstrucaoModo modo, optional<uint16> endereco)
    {
        cpu->d = false;
    }

    //! Limpa a flag 'i'
    static void instrucao_cli(CpuInterface* cpu, InstrucaoModo modo, optional<uint16> endereco)
    {
        cpu->i = false;
    }

    //! Limpa a flag 'v'
    static void instrucao_clv(CpuInterface* cpu, InstrucaoModo modo, optional<uint16> endereco)
    {
        cpu->v = false;
    }

    //! Compara o acumulador com um valor
    static void instrucao_cmp(CpuInterface* cpu, InstrucaoModo modo, optional<uint16> endereco)
    {
        byte valor = cpu->memoria->ler(endereco.value());
    ...
    static void instrucao_cpx(CpuInterface* cpu, InstrucaoModo modo, optional<uint16> endereco)
    {
        byte valor = cpu->memoria->ler(endereco.value());
    ...
    static void instrucao_cpy(CpuInterface* cpu, InstrucaoModo modo, optional<uint16> endereco)
    {
        byte valor = cpu->memoria->ler(endereco.value());
    ...
    static void instrucao_dec(CpuInterface* cpu, InstrucaoModo modo, optional<uint16> endereco)
    {
        byte valor = cpu->memoria->ler(endereco.value());
    ...
    static void instrucao_dex(CpuInterface* cpu, InstrucaoModo modo, optional<uint16> endereco)
    {
        cpu->x -= 1;
    ...
    static void instrucao_dey(CpuInterface* cpu, InstrucaoModo modo, optional<uint16> endereco)
    {
        cpu->y -= 1;
    ...
    static void instrucao_eor(CpuInterface* cpu, InstrucaoModo modo, optional<uint16> endereco)
    {
        byte valor = cpu->memoria->ler(endereco.value());
    ...
    static void instrucao_inc(CpuInterface* cpu, InstrucaoModo modo, optional<uint16> endereco)
    {
        byte valor = cpu->memoria->ler(endereco.value());
    ...
    static void instrucao_inx(CpuInterface* cpu, InstrucaoModo modo, optional<uint16> endereco)
    {
        cpu->x += 1;
    ...
    static void instrucao_iny(CpuInterface* cpu, InstrucaoModo modo, optional<uint16> endereco)
    {
        cpu->y += 1;
    ...
    static void instrucao_jmp(CpuInterface* cpu, InstrucaoModo modo, optional<uint16> endereco)
    {
        // muda o endereço
        cpu->pc = endereco.value();
    }
    ...
    static void instrucao_jsr(CpuInterface* cpu, InstrucaoModo modo, optional<uint16> endereco)
    {
    ...
    static void instrucao_lda(CpuInterface* cpu, InstrucaoModo modo, optional<uint16> endereco)
    {
    ...
    static void instrucao_ldx(CpuInterface* cpu, InstrucaoModo modo, optional<uint16> endereco)
    {
    ...
    //! Carrega um valor da memoria no acumulador
    static void instrucao_ldy(CpuInterface* cpu, InstrucaoModo modo, optional<uint16> endereco)
    {
    ...
    Utiliza a memoria ou o acumulador
    */
    static void instrucao_lsr(CpuInterface* cpu, InstrucaoModo modo, optional<uint16> endereco)
    {
        if (modo == InstrucaoModo::ACM)
        {
    ...
    //! Não fazer nada
    static void instrucao_nop(CpuInterface* cpu, InstrucaoModo modo, optional<uint16> endereco)
    {
    }

    //! Operanção OR entre um valor na memoria e o A
    static void instrucao_ora(CpuInterface* cpu, InstrucaoModo modo, optional<uint16> endereco)
    {
        byte valor = cpu->memoria->ler(endereco.value());
    ...
    static void instrucao_pha(CpuInterface* cpu, InstrucaoModo modo, optional<uint16> endereco)
    {
        cpu->stack_empurrar(cpu->a);
    }

    //! Empurra o valor do estado do processador na stack
    static void instrucao_php(CpuInterface* cpu, InstrucaoModo modo, optional<uint16> endereco)
    {
    ...
    static void instrucao_pla(CpuInterface* cpu, InstrucaoModo modo, optional<uint16> endereco)
    {
    ...
    static void instrucao_plp(CpuInterface* cpu, InstrucaoModo modo, optional<uint16> endereco)
    {
    ...
    static void instrucao_rol(CpuInterface* cpu, InstrucaoModo modo, optional<uint16> endereco)
    {
        if (modo == InstrucaoModo::ACM)
        {
            bool carregar = cpu->c;
    ...
    static void instrucao_ror(CpuInterface* cpu, InstrucaoModo modo, optional<uint16> endereco)
    {
        if (modo == InstrucaoModo::ACM)
        {
            bool carregar = cpu->c;
    ...
    static void instrucao_rti(CpuInterface* cpu, InstrucaoModo modo, optional<uint16> endereco)
    {
        const byte estado = cpu->stack_puxar();
        cpu->set_estado(estado);
    ...
    static void instrucao_rts(CpuInterface* cpu, InstrucaoModo modo, optional<uint16> endereco)
    {
        cpu->pc = cpu->stack_puxar_16_bits() + 1;
    }

    //! Subtrai um valor da memoria usando o acumulador
    static void instrucao_sbc(CpuInterface* cpu, InstrucaoModo modo, optional<uint16> endereco)
    {
        byte valor = cpu->memoria->ler(endereco.value());
    ...
    //! Ativa a flag 'c'
    static void instrucao_sec(CpuInterface* cpu, InstrucaoModo modo, optional<uint16> endereco)
    {
        cpu->c = true;
    }

    //! Ativa a flag 'd'
    static void instrucao_sed(CpuInterface* cpu, InstrucaoModo modo, optional<uint16> endereco)
    {
        cpu->d = true;
    }

    //! Ativa a flag 'i'
    static void instrucao_sei(CpuInterface* cpu, InstrucaoModo modo, optional<uint16> endereco)
    {
        cpu->i = true;
    }

    //! Guarda o valor do acumulador na memoria
    static void instrucao_sta(CpuInterface* cpu, InstrucaoModo modo, optional<uint16> endereco)
    {
        cpu->memoria->escrever(endereco.value(), cpu->a);
    }

    //! Guarda o valor do registrador 'x' na memoria
    static void instrucao_stx(CpuInterface* cpu, InstrucaoModo modo, optional<uint16> endereco)
    {
        cpu->memoria->escrever(endereco.value(), cpu->x);
    }

    //! Guarda o valor do registrador 'y' na memoria
    static void instrucao_sty(CpuInterface* cpu, InstrucaoModo modo, optional<uint16> endereco)
    {
        cpu->memoria->escrever(endereco.value(), cpu->y);
    }

    //! Atribui o valor do acumulador ao registrador 'x'
    static void instrucao_tax(CpuInterface* cpu, InstrucaoModo modo, optional<uint16> endereco)
    {
        cpu->x = cpu->a;
    ...
    static void instrucao_tay(CpuInterface* cpu, InstrucaoModo modo, optional<uint16> endereco)
    {
        cpu->y = cpu->a;
    ...
    static void instrucao_tsx(CpuInterface* cpu, InstrucaoModo modo, optional<uint16> endereco)
    {
        cpu->x = cpu->sp;
    ...
    static void instrucao_txa(CpuInterface* cpu, InstrucaoModo modo, optional<uint16> endereco)
    {
        cpu->a = cpu->x;
    ...
    static void instrucao_txs(CpuInterface* cpu, InstrucaoModo modo, optional<uint16> endereco)
    {
        cpu->sp = cpu->x;
    }

    //! Atribui o valor do registrador 'y' ao acumulador
    static void instrucao_tya(CpuInterface* cpu, InstrucaoModo modo, optional<uint16> endereco)
    {
        cpu->a = cpu->y;
    ...
    static void instrucao_dop(CpuInterface* cpu, InstrucaoModo modo, optional<uint16> endereco)
    {
    }

    //! Instrução não-oficial *TOP - nenhuma operação
    static void instrucao_top(CpuInterface* cpu, InstrucaoModo modo, optional<uint16> endereco)
    {
    }

    //! Instrução não-oficial *LAX - Transfere um valor da memória para A e X
    static void instrucao_lax(CpuInterface* cpu, InstrucaoModo modo, optional<uint16> endereco)
    {
        byte valor = cpu->memoria->ler(endereco.value());
    ...
    static void instrucao_sax(CpuInterface* cpu, InstrucaoModo modo, optional<uint16> endereco)
    {
    ...
    static void instrucao_dcp(CpuInterface* cpu, InstrucaoModo modo, optional<uint16> endereco)
    {
        byte valor = cpu->memoria->ler(endereco.value());
    ...
    static void instrucao_isb(CpuInterface* cpu, InstrucaoModo modo, optional<uint16> endereco)
    {
        byte valor = cpu->memoria->ler(endereco.value());
        byte resultado = valor + 1;
    ...
    */
    static void instrucao_slo(CpuInterface* cpu, InstrucaoModo modo, optional<uint16> endereco)
    {
        byte valor = cpu->memoria->ler(endereco.value());
    ...
    */
    static void instrucao_rla(CpuInterface* cpu, InstrucaoModo modo, optional<uint16> endereco)
    {
        byte valor = cpu->memoria->ler(endereco.value());
    ...
    */
    static void instrucao_sre(CpuInterface* cpu, InstrucaoModo modo, optional<uint16> endereco)
    {
        byte valor = cpu->memoria->ler(endereco.value());
    ...
    */
    static void instrucao_rra(CpuInterface* cpu, InstrucaoModo modo, optional<uint16> endereco)
    {
        byte valor = cpu->memoria->ler(endereco.value());
